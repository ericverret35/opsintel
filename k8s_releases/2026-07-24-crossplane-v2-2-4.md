---
layout: post
title: Crossplane v2.2.4
date: '2026-07-24'
category: k8s-releases
tool: Crossplane
version: v2.2.4
prerelease: false
url: https://github.com/crossplane/crossplane/releases/tag/v2.2.4
tags:
- kubernetes
- cncf
- crossplane
...
**Version**: v2.2.4
**Type**: Stable
**Release**: [https://github.com/crossplane/crossplane/releases/tag/v2.2.4](https://github.com/crossplane/crossplane/releases/tag/v2.2.4)
...
* **Vulnerability-scannable images (#7575):** Container images are now built wi
