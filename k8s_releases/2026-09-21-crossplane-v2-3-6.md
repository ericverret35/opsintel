---
layout: post
title: Crossplane v2.3.6
date: '2026-09-21'
category: k8s-releases
tool: Crossplane
version: v2.3.6
prerelease: false
url: https://github.com/crossplane/crossplane/releases/tag/v2.3.6
tags:
- kubernetes
- cncf
- crossplane
...
**Version**: v2.3.6
**Type**: Stable
**Release**: [https://github.com/crossplane/crossplane/releases/tag/v2.3.6](https://github.com/crossplane/crossplane/releases/tag/v2.3.6)
