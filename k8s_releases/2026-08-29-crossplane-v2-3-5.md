---
layout: post
title: Crossplane v2.3.5
date: '2026-08-29'
category: k8s-releases
tool: Crossplane
version: v2.3.5
prerelease: false
url: https://github.com/crossplane/crossplane/releases/tag/v2.3.5
tags:
- kubernetes
- cncf
- crossplane
...
**Version**: v2.3.5
**Type**: Stable
**Release**: [https://github.com/crossplane/crossplane/releases/tag/v2.3.5](https://github.com/crossplane/crossplane/releases/tag/v2.3.5)
...
* **Unambiguous `Usage` index key (#7630, originally #7508):** The deletion protection webhook indexed `Usage` resources by joining API group, kind, name, and namespace with `.`. Since groups and names can contain `.` them
