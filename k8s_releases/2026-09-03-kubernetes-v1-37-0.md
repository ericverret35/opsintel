...
**Version**: v1.37.0
**Type**: Stable
**Release**: [https://github.com/kubernetes/kubernetes/releases/tag/v1.37.0](https://github.com/kubernetes/kubernetes/releases/tag/v1.37.0)
