...
**Version**: v1.35.8
**Type**: Stable
**Release**: [https://github.com/kubernetes/kubernetes/releases/tag/v1.35.8](https://github.com/kubernetes/kubernetes/releases/tag/v1.35.8)
