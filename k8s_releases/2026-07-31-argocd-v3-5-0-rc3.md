---
layout: post
title: ArgoCD v3.5.0-rc3
date: '2026-07-31'
category: k8s-releases
tool: ArgoCD
version: v3.5.0-rc3
prerelease: true
url: https://github.com/argoproj/argo-cd/releases/tag/v3.5.0-rc3
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.5.0-rc3
**Type**: Pre-release
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.5.0-rc3](https://github.com/argoproj/argo-cd/releases/tag/v3.5.0-rc3)
