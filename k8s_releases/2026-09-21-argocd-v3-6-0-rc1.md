---
layout: post
title: ArgoCD v3.6.0-rc1
date: '2026-09-21'
category: k8s-releases
tool: ArgoCD
version: v3.6.0-rc1
prerelease: true
url: https://github.com/argoproj/argo-cd/releases/tag/v3.6.0-rc1
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.6.0-rc1
**Type**: Pre-release
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.6.0-rc1](https://github.com/argoproj/argo-cd/releases/tag/v3.6.0-rc1)
