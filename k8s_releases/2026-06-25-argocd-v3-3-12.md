---
layout: post
title: ArgoCD v3.3.12
date: '2026-06-25'
category: k8s-releases
tool: ArgoCD
version: v3.3.12
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.3.12
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.3.12
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.3.12](https://github.com/argoproj/argo-cd/releases/tag/v3.3.12)
