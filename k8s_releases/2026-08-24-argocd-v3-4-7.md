...
version: v3.4.7
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.4.7
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.4.7
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.4.7](https://github.com/argoproj/argo-cd/releases/tag/v3.4.7)
