...
version: v3.5.3
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.5.3
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.5.3
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.5.3](https://github.com/argoproj/argo-cd/releases/tag/v3.5.3)
