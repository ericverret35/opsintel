---
layout: post
title: ArgoCD v3.3.13
date: '2026-08-07'
category: k8s-releases
tool: ArgoCD
version: v3.3.13
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.3.13
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.3.13
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.3.13](https://github.com/argoproj/argo-cd/releases/tag/v3.3.13)
