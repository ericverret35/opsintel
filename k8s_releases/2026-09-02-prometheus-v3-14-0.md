---
layout: post
title: Prometheus v3.14.0
date: '2026-09-02'
category: k8s-releases
tool: Prometheus
version: v3.14.0
prerelease: false
url: https://github.com/prometheus/prometheus/releases/tag/v3.14.0
tags:
- kubernetes
- cncf
- prometheus
...
**Version**: v3.14.0
**Type**: Stable
**Release**: [https://github.com/prometheus/prometheus/releases/tag/v3.14.0](https://github.com/prometheus/prometheus/releases/tag/v3.14.0)
