---
layout: post
title: Helm v4.3.0-rc.1
date: '2026-09-02'
category: k8s-releases
tool: Helm
version: v4.3.0-rc.1
prerelease: true
url: https://github.com/helm/helm/releases/tag/v4.3.0-rc.1
tags:
- kubernetes
- cncf
- helm
...
**Version**: v4.3.0-rc.1
**Type**: Pre-release
**Release**: [https://github.com/helm/helm/releases/tag/v4.3.0-rc.1](https://github.com/helm/helm/releases/tag/v4.3.0-rc.1)
...
The official changelog will come out with the v4.3.0 release. For now, you can see the commit changes from v4.2.4 [here](https://github.com/helm/helm/compare/v4.2.4...v4.3.0-rc.1).
