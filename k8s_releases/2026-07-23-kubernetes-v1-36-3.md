...
**Version**: v1.36.3
**Type**: Stable
**Release**: [https://github.com/kubernetes/kubernetes/releases/tag/v1.36.3](https://github.com/kubernetes/kubernetes/releases/tag/v1.36.3)
