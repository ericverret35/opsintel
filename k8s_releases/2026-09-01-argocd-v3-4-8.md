...
version: v3.4.8
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.4.8
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.4.8
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.4.8](https://github.com/argoproj/argo-cd/releases/tag/v3.4.8)
