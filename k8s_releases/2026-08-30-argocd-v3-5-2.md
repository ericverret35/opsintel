...
version: v3.5.2
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.5.2
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.5.2
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.5.2](https://github.com/argoproj/argo-cd/releases/tag/v3.5.2)
