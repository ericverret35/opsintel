...
version: v3.4.9
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.4.9
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.4.9
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.4.9](https://github.com/argoproj/argo-cd/releases/tag/v3.4.9)
