...
version: v3.4.6
prerelease: false
url: https://github.com/argoproj/argo-cd/releases/tag/v3.4.6
tags:
- kubernetes
- cncf
- argocd
...
**Version**: v3.4.6
**Type**: Stable
**Release**: [https://github.com/argoproj/argo-cd/releases/tag/v3.4.6](https://github.com/argoproj/argo-cd/releases/tag/v3.4.6)
